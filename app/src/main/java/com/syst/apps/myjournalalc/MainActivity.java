...
public class MainActivity extends AppCompatActivity {
    ...
    // TOD (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "textVw";
    ...
    // TOD (2) Override onSaveInstanceState
    // Do steps 3 - 5 within onSaveInstanceState
    // TOD (3) Call super.onSaveInstanceState
    // TOD (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
    // TOD (5) Put the text from the TextView in the outState bundle
